...
const StatusText: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 20, pointerEvents: 'none' }}>
    <p style={{ color: "white", fontSize: "2.25rem", fontWeight: "800", background: "rgba(0,0,0,0.7)", padding: "1rem 2rem", borderRadius: "0.5rem", backdropFilter: "blur(5px)", border: "1px solid rgba(34,211,238,0.3)" }}>
      {children}
    </p>
  </div>
);
